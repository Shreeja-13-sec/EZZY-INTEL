...
@Composable
fun ERIndividual(navController: NavHostController) {
    ...
    Column(modifier = Modifier.background(Color(0xFFFFCC66)), horizontalAlignment = Alignment.CenterHorizontally,
        ...
        Column(
            ...
            Text(
                text = "Education Individual Registration",
                fontSize = 20.sp,
                color = Color.Black,
            ...
            OutlinedTextField(value = registerAs, onValueChange = { registerAs = it }, label = { Text("Register As") },
                ...
                placeholder = {
                    Text(
                        text = "Online Mentor, Teacher, Tutor...",
                        fontSize = 14.sp,
                        color = Color.Black
                    )
                }
            ...
            OutlinedTextField(value = subject, onValueChange = { subject = it }, label = { Text("Subject") },
                ...
                placeholder = {
                    Text(
                        text = "Biology, Computer Science, Bharatanatyam, Carnatic Singing...",
                        fontSize = 14.sp,
                        color = Color.Black
                    )
                }
            ...
            OutlinedTextField(value = experience, onValueChange = { experience = it }, label = { Text("Experience") },
                ...
                placeholder = {
                    Text(
                        text = "Experience: 1 year,6 months...",
                        fontSize = 14.sp,
                        color = Color.Black
                    )
                }
            ...
            OutlinedTextField(value = workLocation, onValueChange = { workLocation = it }, label = { Text("Work Location") },
                ...
                placeholder = {
                    Text(
                        text = "Location of service: Chennai, Mumbai, Bangalore...",
                        fontSize = 14.sp,
                        color = Color.Black
                    )
                }
            ...
            OutlinedTextField(value = workAddress, onValueChange = { workAddress = it }, label = { Text("Work Address") },
                ...
                placeholder = {
                    Text(
                        text = "Tutoring address else NIL",
                        fontSize = 14.sp,
                        color = Color.Black
                    )
                }
            ...
            Button(
                onClick = {
                    if (registerAs.isNotEmpty() && name.isNotEmpty() && qualification.isNotEmpty() && subject.isNotEmpty() && experience.isNotEmpty() && age.isNotEmpty() && gender.isNotEmpty() && workLocation.isNotEmpty() && workAddress.isNotEmpty() && description.isNotEmpty() && phoneNumber.isNotEmpty() && mailId.isNotEmpty()) {
                        val edu = hashMapOf(
