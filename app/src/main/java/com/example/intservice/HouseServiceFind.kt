...
@Composable
fun houseServicesFind(navController: NavHostController){
                    ...
                    db.collection("housingServices")
                        ...
                        .addOnSuccessListener { result ->
                            ...
                            for (document in result) {
                                if (document.get("Service Location") == location) {
                                    data1.append("Service Type - " + document.get("Service Type") + "\n")
                                    data1.append("Name - " + document.get("Name") + "\n")
                                    data1.append("Service Location - " + document.get("Service Location") + "\n")
                                    ...
                                    data2.append("Service Type - " + document.get("Service Type") + "\n")
                                    data2.append("Name - " + document.get("Name") + "\n")
                                    data2.append("Service Location - " + document.get("Service Location") + "\n")
